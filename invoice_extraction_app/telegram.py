...
Endpoint:
  /api/method/invoice_extraction_app.telegram.webhook
...
def _create_extracted_invoice_with_attachment(*, file_name: str, content: bytes, kind: str) -> str:
    ...
    frappe.enqueue(
        "invoice_extraction_app.api.extract_and_update_extracted_invoice",
        queue="default",
...
def setup_webhook1(webhook_base_url: Optional[str] = None) -> Dict[str, Any]:
    ...
    Usage (server-side):
      bench --site <site> execute invoice_extraction_app.telegram.setup_webhook --kwargs "{'webhook_base_url':'https://...'}"
    """
    ...
    webhook_url = f"{base}/api/method/invoice_extraction_app.telegram.webhook"
...
def setup_webhook() -> Dict[str, Any]:
    ...
    webhook_url = f"{public_base_url}/api/method/invoice_extraction_app.telegram.webhook"
